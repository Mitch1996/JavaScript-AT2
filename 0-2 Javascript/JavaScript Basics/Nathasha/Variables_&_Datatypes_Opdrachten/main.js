...
//Opdracht 1.1:
let letOefeningaangepast = "Let Tekst"
let LetOefeninga = "Let Tekst twee"
console.log(letOefeningaangepast)
let letOefening = "Let Tekst"
console.log(letOefening)
LetletOefening = "Let Tekst twee" 
console.log(LetletOefening)
const constOefening = "Const Tekst";
console.log(constOefening)
constOefeningtwee = "Const Tekst Twee!";
console.log(constOefeningtwee)
//Opdracht 1.2:
...
let SomeNumber2 = Boolean;
console.log(!SomeNumber2)
let SomeNumber3 = false;
console.log(!SomeNumber3)
let SomeNumber4 = "false";
console.log(!SomeNumber4)
let SomeNumber5 = true;
console.log(!SomeNumber5)
let SomeNumber6 = "true";
console.log(!SomeNumber6)
let SomeNumber7 = null;
console.log(!SomeNumber7)
let SomeNumber8 = undefined;
console.log(!SomeNumber8)
